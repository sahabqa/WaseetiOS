...
public class AddCraftsAndContractingPost extends CapsFile {
	...
	@Test(enabled = false)
	public void AddAluminumAndKitchensPostWithImages() throws IOException, InterruptedException {
		...
		// Add Aluminum And Kitchens Post Step ONE scenario
		...
		// Add Aluminum And Kitchens Post Step TWO scenario
	...
	@Test
	public void AddAluminumAndKitchensPostWithoutImages() throws IOException, InterruptedException {
