...
public class AddAnimalsPost extends CapsFile {
	...
	@Test
	public void AddAnimalsPostWithImages() throws IOException, InterruptedException {
		...
		// Add Animals Post Step ONE scenario

		ChooseSection.Animals.click();
		ChooseSection.Horses.click();
		...
		// Add Animals Post Step TWO scenario
	...
	@Test
	public void AddAnimalsPostWithoutImages() throws IOException, InterruptedException {
