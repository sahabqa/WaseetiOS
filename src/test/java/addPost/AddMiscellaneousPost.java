...
public class AddMiscellaneousPost extends CapsFile {
	...
	@Test(enabled = false)
	public void AddMiscellaneousPostWithImages() throws IOException, InterruptedException {
		...
		ChooseSection.WantedThings.click();
	...
	@Test
	public void AddMiscellaneousPostWithoutImages() throws IOException, InterruptedException {
