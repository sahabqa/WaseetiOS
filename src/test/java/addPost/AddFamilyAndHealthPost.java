...
public class AddFamilyAndHealthPost extends CapsFile {
	...
	@Test(enabled = false)
	public void AddClothesPostWithImages() throws IOException, InterruptedException {
		...
		// Add Clothes Post Step ONE scenario
		...
		// Add Clothes Post Step TWO scenario
	...
	@Test
	public void AddClothesPostWithoutImages() throws IOException, InterruptedException {
