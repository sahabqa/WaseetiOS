...
public class AddFurnituresPost extends CapsFile {
	...
	@Test(enabled = false)
	public void AddHomeFurnishingsPostWithImages() throws IOException, InterruptedException {
		...
		// Add Home Furnishings Post Step ONE scenario
		...
		// Add Home Furnishings Post Step TWO scenario
	...
	@Test
	public void AddHomeFurnishingsPostWithoutImages() throws IOException, InterruptedException {
