...
public class AddEnginesAndMechanismsPost extends CapsFile {
	...
	@Test(enabled = false)
	public void AddBoatsPostWithImages() throws IOException, InterruptedException {
		...
		// Add Boats Post Step ONE scenario

		ChooseSection.EnginesAndMechanisms.click();
		ChooseSection.MarineBoats.click();
		...
		// Add Boats Post Step TWO scenario
	...
	@Test
	public void AddBoatsPostWithoutImages() throws IOException, InterruptedException {
